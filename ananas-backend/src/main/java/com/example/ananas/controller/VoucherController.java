...
public class VoucherController {
    ...
    public ResponseEntity<ResultPaginationDTO> getAllVouchersForAdmin(
            @Filter Specification<Voucher> specification, Pageable pageable) {
    ...
    public ResponseEntity<BigDecimal> getSumDiscount(
            @RequestParam(name = "code") String code, @RequestParam(name = "price") BigDecimal price) {
